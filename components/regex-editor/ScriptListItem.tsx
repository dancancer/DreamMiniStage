          ...
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
              {selectionMode ? (
                /* 选择模式：显示复选框 */
                <button
                  onClick={() => onToggleSelection?.(scriptId)}
                  className="shrink-0 w-5 h-5 rounded border-2 transition-all duration-200 flex items-center justify-center"
                  style={{
                    borderColor: isSelected ? "rgb(var(--primary-500))" : "rgb(var(--border))",
                    backgroundColor: isSelected ? "rgb(var(--primary-500))" : "transparent",
                  }}
                >
                  {isSelected && (
                ...
                <Button
                  ...
                  className="text-ink-soft hover:text-cream h-6 w-6 shrink-0"
                >
