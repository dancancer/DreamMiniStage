  ...
  const content = (
    <div className={containerClasses}>
      ...
      <div className="flex items-center gap-1 sm:gap-1.5">
        ...
        >
          <div className={`flex items-center justify-center w-3 h-3 sm:w-4 sm:h-4 rounded-full ${sortOrder === "asc" ? "bg-primary/20 text-primary-400" : "bg-accent/30 text-sky"} transition-all duration-300`}>
