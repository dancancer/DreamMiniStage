...
- network-ga-request-aborted (known-noise) x 44
- network-openai-mock-401 (expected-failfast) x 2
- network-openai-response-401 (expected-failfast) x 2
- network-openai-translate-mock-200 (expected-success) x 1
- network-vercel-script-aborted (known-noise) x 1
...
- matchedRuleCount: 6
- unusedRuleCount: 1
- unused: network-session-rsc-aborted
