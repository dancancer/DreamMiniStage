...
export function artifactPaths(runDir) {
  return {
    ...
    console: path.join(runDir, "round12-console.log"),
    network: path.join(runDir, "round12-network.log"),
    noiseReportJson: path.join(runDir, "round12-noise-baseline-report.json"),
    noiseReportMd: path.join(runDir, "round12-noise-baseline-report.md"),
